...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, default='/home/gaoshangqi/Restoration_ef/FlareSeg22/coarse_base_seg/config.yaml', help='config file path')
    parser.add_argument('--local_rank', type=str, default='3',
