...
if __name__ == '__main__':
    ...
    if cfg.ENVIRONMENT.DATA_BASE_DIR is not None:
        ...
        cfg.DATA_PREPARE.TRAINU_SERIES_IDS_TXT = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.TRAINU_SERIES_IDS_TXT
        ...
        cfg.DATA_PREPARE.TRAINU_IMAGE_DIR = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_PREPARE.TRAINU_IMAGE_DIR
        ...
        cfg.DATA_PREPARE.DEFAULT_TRAIN_DB = None
        cfg.DATA_PREPARE.DEFAULT_TRAINU_DB = None
        cfg.DATA_PREPARE.DEFAULT_VAL_DB = None
    cfg.freeze()
