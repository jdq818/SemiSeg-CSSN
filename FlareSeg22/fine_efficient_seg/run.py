...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', '--config', type=str, default='./FlareSeg22/fine_efficient_seg/config.yaml',
    ...
    if cfg.ENVIRONMENT.DATA_BASE_DIR is not None:
        ...
        cfg.DATA_LOADER.TRAINU_DB_FILE = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.DATA_LOADER.TRAINU_DB_FILE
    ...
    trainu_db_path = cfg.DATA_LOADER.TRAINU_DB_FILE
    ...
    for exp_name, exp_config in tune_params.items():
        ...
        for fold in cfg.DATA_LOADER.FIVE_FOLD_LIST:
            ...
            cfg.DATA_LOADER.TRAINU_DB_FILE = trainu_db_path
            ...
            cfg.TESTING.SAVER_DIR = '/home/gaoshangqi/Restoration_ef/FlareSeg22/output/val'
            cfg.TESTING.IS_SAVE_MASK = False
            segmentation = SegmentationMultiProcess()
            run_multiprocessing(segmentation.run, cfg, 1)

            cfg.DATA_LOADER.TEST_DB_FILE = test_db_path
            cfg.TESTING.SAVER_DIR = '/home/gaoshangqi/Restoration_ef/FlareSeg22/output/test'
